...
SECRET_KEY = 'django-insecure-vz0ksa0o_czhpnsh1g)&f+sny*ul!l&6+$17-js_djs=oo*!g1'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'voicevista'),
        'USER': os.getenv('POSTGRES_USER', 'postgres'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'example'),
        'HOST': os.getenv('DB_HOST', 'voicevista-db'),
...
def configure(binder: Binder) -> Binder:
    binder.bind(UserServiceInterface, to=UserService)
